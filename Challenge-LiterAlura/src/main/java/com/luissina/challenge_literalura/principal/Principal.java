package com.luissina.challenge_literalura.principal;

import com.luissina.challenge_literalura.Challenge.LiterAlura.dto.Datos;
...
import com.luissina.challenge_literalura.service.ConsumoAPI;
import com.luissina.challenge_literalura.service.ConvierteDatos;
...
public class Principal {
    ...
    private void listarLibrosPorIdioma() {
        List<Idioma> listadoIdiomas = idiomaRepository.findAll();
    ...
    private void buscarLibroPorTitulo() {
        ...
        if (json == null){
            ...
            var totalLibros = datos.count();
            if (totalLibros > 0){
                var contador = datos.results().size();
                for (int i = 0; i < contador; i++) {
                    DatosLibro datosLibro = datos.results().get(i);
                    ...
                    Optional<Idioma> idiomaEntityOptional = idiomaRepository.findByNombreIgnoreCase(String.valueOf(datosLibro.languages().get(0)));
